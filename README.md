...
| Имя               | Роль          | GitHub                                  |
|--------------------|---------------|------------------------------------------|
| Анна Милютина     | Аналитика     | [millana4](https://github.com/millana4)  |
| Иван Людвиков     | Разработка    | [Vanusha61](https://github.com/Vanusha61)|
| Артём Царюк       | Тимлид        | [funcid](https://github.com/funcid)      |
| Абида Аюшиев      | Тестировщик   | [ayutoso28](https://github.com/ayutoso28)|
| Альбина Шустова   | Разработка    | [AlbinaShu](https://github.com/AlbinaShu)|
...
1. Разработать модель данных для реализации основных функцийпроекта. Минимальный набор таблиц:
* транзакция: идентификатор, наименование, тип (доход илирасход), категория, сумма, дата, ссылка на пользователя;
* группа: таблица позволяющая объединить пользователей вгруппы например для учёта семейных транзакций, идентификатор группы, название группы, ссылка напользователя.
